...
module Docscribe
  module InlineRewriter
    ...
    module SourceHelpers
      ...
      # @param [Object] node def or defs AST node
      # @return [Object]
      def node_name(node)
        case node.type
      ...
      # @param [Object] buffer source buffer for range
      # @param [Object] node target AST node
      # @return [Range]
      ...
      # @param [Object] buffer source buffer to scan
      ...
      # @param [Object] lines source code lines
      # @param [Object] def_line_idx def line index
      # @return [Hash]
      ...
      # @param [Object] lines source code lines
      # @param [Object] start_idx block start index
      # @param [Object] end_idx block end index
      # @return [Integer]
      ...
      # @param [Object] lines source code lines
      # @param [Object] start_idx block start index
      # @param [Object] preserved_start_idx preserved start index
      # @param [Object] end_idx block end index
      # @return [Hash]
      ...
      # @param [Object] buffer source buffer for position
      # @param [Object] lines source code lines
      # @param [Object] preserved_start_idx preserved start index
      # @param [Object] def_bol_pos beginning-of-line position of the target def
      # @return [Range]
      ...
      # @param [Object] lines source code lines
      # @param [Object] start_idx block start index
      # @param [Object] doc_start_idx doc content start index
      # @param [Object] end_pos_idx block end position index
      # @return [Hash]
      ...
      # @param [Object] line comment line to check
      # @return [Boolean]
      ...
      # @param [Object] buffer source buffer to check
      # @param [Object] insert_pos insertion position
      # @return [Boolean]
