...
RSpec.describe Docscribe::InlineRewriter do
  describe 'adds @raise when none exists' do
    ...
    it 'adds @raise when none exists and inference finds raises', :aggregate_failures do
  ...
  describe 'does not append inferred @raise types that are already documented' do
    ...
    it 'does not append inferred @raise types that are already documented', :aggregate_failures do
